...
appMainModule.controller("AccountChangePasswordController", function ($scope, $http, viewModelHelper, validator) {

    $scope.viewModelHelper = viewModelHelper;
    $scope.passwordModel = new EIMS.AccountChangePasswordModel();
